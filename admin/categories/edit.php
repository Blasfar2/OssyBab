                    ...
                    <div class="order">
                        <div class="container-fluid admin">
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="both" style="display: flex;flex-direction: column;align-items: center;">

                                            <div style="width: 75%; margin: 0 10px;">
                                                <form action="process.php" method="post" enctype="multipart/form-data">
                                                    <div class="form-element my-4">
                                                        <input type="hidden" name="categoryId" value="<?php echo $row['CategoryID']; ?>">
                                                        <input type="hidden" name="oldImage" value="<?php echo $row['CategoryImage']; ?>">
                                            ...
                                            <div class="form-element" style="display: flex;justify-content: center;">
